...
/// <summary>
/// Data-driven editor utility to create Ability Catalog Recipe assets for all jobs
/// Reads catalog definitions from JSON files and generates Unity ScriptableObject assets
/// </summary>
public static class CatalogAssetGenerator
{
    ...
    [MenuItem("Tactics RPG/Generate Content/Catalogs")]
